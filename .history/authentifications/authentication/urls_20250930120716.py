...
#...existing code...
    ...
    path('generatePayement2-pdf/<int:paiementloyer_id>/', PDFTemplateViewpaiyement1.as_view(), name='generate_pdfpayement1'),  # noqa: F821
    path('paiement/<int:paiementloyer_id>/download/', Download_Payement2_RedirectView.as_view(), name='download_and_redirect_payement1'),
