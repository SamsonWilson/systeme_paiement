...
from .views import  ChambreCreateView, ChambreDeleteView, ChambreDetailLocataireView, ChambreDetailView, ChambreListView, ChambreUpdateView, ChatView, CheckUnreadMessagesAPIView,  ConversationDetailView, ConversationListView, CustomLoginView, DashboarProprietairedView, Download_Payement1_RedirectView, Download_Payement2_RedirectView, Download_location_RedirectView, FinLocationCreateView, FinLocationListView, FinLocationUpdateView, GeneratePDFView, GroupMessagesListView, InboxView, ListePaiementsLocationView, LocataireDashboardView, LocationCreateView, LocationDeleteView, LocationListView, LocationUpdateView, MaisonCreateView, MaisonDeleteView, MaisonDetailView, MaisonListView, MaisonLocatairesView, MaisonMessageView, MaisonUpdateView, MessageCreateView, PDFTemplateViewLocation, PDFTemplateViewpaiyement1, PDFTemplateViewpaiyement2, PaiementLoyer2CreateView, PaiementLoyerCreateView, PaiementLoyerDeleteView, PaiementLoyerListView, PaiementLoyerUpdateView, PrivateChatView, ProprietaireCreateView, ProprietaireDashboardView, ProprietaireDeleteView, ProprietaireDetailView, ProprietaireDetaimaisonlView, ProprietaireListView, ProprietaireListmaisonView, ProprietaireUpdateView, RedirectionParTypeUtilisateurView, ServePDFAndRedirectViewLocation, ServePDFAndRedirectViewpaiyement, SignUpView, TableauDeBordView, TableauView, TypeChambreCreateView, TypeChambreDeleteView, TypeChambreListView, TypeChambreUpdateView, UserDetailView, UserListView, UserUpdateReinitialisationPasswordView, UserUpdateView, UtilisateurList_PeyementView, UtilisateurListView , VilleCreateView, VilleDeleteView, VilleListView, VilleUpdateView, QuartierCreateView, QuartierDeleteView, QuartierListView, QuartierUpdateView
...
urlpatterns = [
    ...
    path('tableau_de_bord/', TableauView.as_view(), name='tableau_de_bord'),
   ...
   #...existing code...
    ...
    # 2. La vue de conversation pour une maison spécifique
    path('messagerie/groupe/<int:pk>/', MaisonMessageView.as_view(), name='maison_messages'),
    # 3. La liste des locataires pour une maison (vue par l'admin)
    path('messages/maison/<int:maison_id>/locataires/', MaisonLocatairesView.as_view(), name='maison_locataires'),
    path('messages/chat/<int:user_id>/', PrivateChatView.as_view(), name='private_chat'),
     # Nouvelle URL pour notre API, on utilise .as_view()
    path('api/maison/<int:maison_id>/check-unread/', CheckUnreadMessagesAPIView.as_view(), name='check_unread_api'),
...
#...existing code...
    ...
    # paiement premier partie 
    path('generatePayement1-pdf/<int:paiementloyer_id>/', PDFTemplateViewpaiyement1.as_view(), name='generate_pdfpayement1'),  # noqa: F821
    path('paiement/<int:paiementloyer_id>/download/', Download_Payement1_RedirectView.as_view(), name='download_and_redirect_payement1'),
    path('generatePayement2-pdf/<int:paiementloyer_id>/', PDFTemplateViewpaiyement2.as_view(), name='generate_pdfpayement2'),  # noqa: F821
    path('paiement/<int:paiementloyer_id>/download/', Download_Payement2_RedirectView.as_view(), name='download_and_redirect_payement2'),
