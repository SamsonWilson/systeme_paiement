...
urlpatterns = [
   ...
   #...existing code...
    ...
    path("messages/<int:maison_id>/new/", GetNewMessagesView.as_view(), name="get_new_messages"),
    path('api/messages/check/<int:maison_id>/', CheckNewMessagesView.as_view(), name='check_new_messages'),
#...existing code...
    # proprietaire 
