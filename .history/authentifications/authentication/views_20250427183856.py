...
from djfrom django.utils.timezone import now
...
class ChatView(LoginRequiredMixin, View):
    def get(self, request, receiver_id=None, maison_id=None):
        ...
        # Si un ID de maison est fourni, charger les messages de groupe pour cette maison
        if maison_id:
        ...
        # Sinon, charger les messages individuels avec un utilisateur spécifique
        if receiver_id:
