...
urlpatterns = [
    ...
    # PaiementLoyer
    path('paiement/creer/<int:location_id>/', PaiementLoyerCreateView.as_view(), name='creer_paiement'),path('paiement/creer/<int:location_id>/', PaiementLoyerCreateView.as_view(), name='creer_paiement'),
