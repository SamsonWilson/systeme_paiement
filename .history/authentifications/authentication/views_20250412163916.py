...
class PaiementLoyerListView(ListView):
    template_name = 'accuiel/paiements/paiement_list.html'
    context_object_name = 'paiements'
    paginate_by = 15  # pagination de 15 lignes
    ...
    def get_context_data(self, **kwargs):
        ...
        # On récupère les locations et leurs relations pour éviter les requêtes multiples
        locations = Location.objects.select_related('chambre', 'utilisateur')
        ...
        # Pagination manuelle
        paginator = Paginator(paiements_par_location, self.paginate_by)  # noqa: F821
        page_number = self.request.GET.get('page')
        page_obj = paginator.get_page(page_number)
dd
        # Mise à jour du context
        context.update({
            'paiements_par_location': page_obj,  # éléments paginés
            'page_obj': page_obj,
