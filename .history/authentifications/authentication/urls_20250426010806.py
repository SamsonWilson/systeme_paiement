...
from .views import  ChambreCreateView, ChambreDeleteView, ChambreDetailView, ChambreListView, ChambreUpdateView, ChatView, ConversationDetailView, ConversationListView, CustomLoginView, FinLocationCreateView, FinLocationListView, FinLocationUpdateView, GeneratePDFView, GetMessagesView, ListePaiementsLocationView, LocationCreateView, LocationDeleteView, LocationListView, LocationUpdateView, MaisonCreateView, MaisonDeleteView, MaisonDetailView, MaisonListView, MaisonUpdateView, MessageCreateView, PDFTemplateViewLocation, PDFTemplateViewpaiyement, PaiementLoyer2CreateView, PaiementLoyerCreateView, PaiementLoyerDeleteView, PaiementLoyerListView, PaiementLoyerUpdateView, ProprietaireCreateView, ProprietaireDeleteView, ProprietaireDetailView, ProprietaireDetaimaisonlView, ProprietaireListView, ProprietaireListmaisonView, ProprietaireUpdateView, RedirectionParTypeUtilisateurView, SendMessageView, ServePDFAndRedirectViewLocation, ServePDFAndRedirectViewpaiyement, SignUpView, TableauDeBordView, TypeChambreCreateView, TypeChambreDeleteView, TypeChambreListView, TypeChambreUpdateView, UtilisateurList_PeyementView, UtilisateurListView , VilleCreateView, VilleDeleteView, VilleListView, VilleUpdateView, QuartierCreateView, QuartierDeleteView, QuartierListView, QuartierUpdateView
...
urlpatterns = [
   ...
   #...existing code...
    ...
    # path('chat/<int:receiver_id>/', ChatView.as_view(), name='chat_page'),
    # path('send-message/', SendMessageView.as_view(), name='send_message'),
    # path('get-messages/', GetMessagesView.as_view(), name='get_messages'),
    path('', ConversationListView.as_view(), name='conversation_list'),
    path('message/<int:pk>/', ConversationDetailView.as_view(), name='conversation_detail'),
