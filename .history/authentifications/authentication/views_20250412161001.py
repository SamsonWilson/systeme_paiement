...
class PaiementLoyerListView(ListView):
    ...
    def get_queryset(self):
        # On récupère toutes les locations avec leurs chambres et utilisateurs
        locations = Location.objects.select_related('chambre', 'utilisateur')

        # Création d'une liste pour les données à afficher
