...
class MaisonLocatairesView(LoginRequiredMixin, View):
    # """Affiche la liste des locataires d'une maison (admin seulement)."""
    ...
    #         # Notifications par locataire
    #         notifications = {
    #             loc.id: Message.objects.filter(receiver=user, sender=loc, is_read=False).count()
    #             for loc in locataires
    #         }

    #         context = {"maison": maison, "locataires": locataires, "notifications": notifications, "mode": "admin"}
    ...
    #         context = {"maison": maison, "admin": admin, "unread_count": unread_count, "mode": "locataire"}
