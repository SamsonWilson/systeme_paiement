...
class PaiementLoyerListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # On récupère toutes les locations avec leurs chambres et utilisateurs pour éviter les requêtes multiples
        locations = Location.objects.select_related('chambre', 'utilisateur')

        for location in locations:
            # Récupérer le dernier paiement pour chaque location
