...
class PaiementLoyer2CreateView(LoginRequiredMixin, CreateView):
    model = PaiementLoyer
    form_class = PaiementLoyerForm
    template_name = 'accueil/paiements/paiement_form2.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        # Récupération du dernier paiement effectué pour cette location
        ...
        context['date_fin_paiement'] = dernier_paiement.
Exception in thread django-main-thread:
Traceback (most recent call last):
  File "C:\Users\hugues\AppData\Local\Programs\Python\Python311\Lib\threading.py", line 1045, in _bootstrap_inner
    self.run()
  File "C:\Users\hugues\AppData\Local\Programs\Python\Python311\Lib\threading.py", line 982, in run
    self._target(*self._args, **self._kwargs)
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\utils\autoreload.py", line 64, in wrapper
    fn(*args, **kwargs)
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\core\management\commands\runserver.py", line 134, in inner_run
    self.check(display_num_errors=True)
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\core\management\base.py", line 486, in check
    all_issues = checks.run_checks(
                 ^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\core\checks\registry.py", line 88, in run_checks
    new_errors = check(app_configs=app_configs, databases=databases)
                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\core\checks\urls.py", line 136, in check_custom_error_handlers
    handler = resolver.resolve_error_handler(status_code)
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\urls\resolvers.py", line 732, in resolve_error_handler
    callback = getattr(self.urlconf_module, "handler%s" % view_type, None)
                       ^^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\utils\functional.py", line 47, in __get__
    res = instance.__dict__[self.name] = self.func(instance)
                                         ^^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\urls\resolvers.py", line 711, in urlconf_module
    return import_module(self.urlconf_name)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\AppData\Local\Programs\Python\Python311\Lib\importlib\__init__.py", line 126, in import_module
  ...
  File "C:\Users\hugues\Music\Projet text\authentifications\authentifications\urls.py", line 24, in <module>
    path('', include('authentication.urls')),
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\hugues\Music\Projet text\.venv\Lib\site-packages\django\urls\conf.py", line 39, in include
  ...
  File "<frozen importlib._bootstrap_external>", line 940, in exec_module
  File "<frozen importlib._bootstrap>", line 241, in _call_with_frames_removed
  File "C:\Users\hugues\Music\Projet text\authentifications\authentication\urls.py", line 2, in <module>
    from .views import  ChambreCreateView, ChambreDeleteView, ChambreDetailView, ChambreListView, ChambreUpdateView, CustomLoginView, GeneratePDFView, LocationCreateView, LocationDeleteView, LocationListView, LocationUpdateView, MaisonCreateView, MaisonDeleteView, MaisonDetailView, MaisonListView, MaisonUpdateView, PDFTemplateViewLocation, PDFTemplateViewpaiyement, PaiementLoyer2CreateView, PaiementLoyerCreateView, PaiementLoyerDeleteView, PaiementLoyerListView, PaiementLoyerUpdateView, ProprietaireCreateView, ProprietaireDeleteView, ProprietaireDetailView, ProprietaireListView, ProprietaireUpdateView, ServePDFAndRedirectViewLocation, ServePDFAndRedirectViewpaiyement, SignUpView, TableauDeBordView, TypeChambreCreateView, TypeChambreDeleteView, TypeChambreListView, TypeChambreUpdateView, UtilisateurList_PeyementView, UtilisateurListView , VilleCreateView, VilleDeleteView, VilleListView, VilleUpdateView, QuartierCreateView, QuartierDeleteView, QuartierListView, QuartierUpdateView
  File "C:\Users\hugues\Music\Projet text\authentifications\authentication\views.py", line 736
    context['date_fin_paiement'] = dernier_paiement. if dernier_paiement else None
                                                     ^^
SyntaxError: invalid syntax if dernier_paiement else None
