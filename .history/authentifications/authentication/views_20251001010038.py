...
from django.contrib.auth.mixins import LoginRequiredMixin
from django.core.exceptions import PermissionDenied
from .models import Maison, Message, CustomUser # Assurez-vous d'importer vos modèles

# 
# La vue MessageListView est supprimée car elle est un doublon de InboxView.
#

class InboxView(LoginRequiredMixin, View):
    """
    Affiche la liste des conversations (boîte de réception).
    - Pour un admin : toutes les maisons.
    - Pour un locataire : uniquement les maisons qu'il loue.
    """
    ...
    def get(self, request, *args, **kwargs):
        if request.user.is_staff:
            ...
            # ✅ CORRIGÉ : On utilise notre nouvelle méthode du modèle CustomUser
        ...
        # Trie les conversations pour que celles avec les messages les plus récents apparaissent en premier
        conversations.sort(
...
class MaisonLocatairesView(LoginRequiredMixin, View):
    """
    Affiche la liste des locataires pour une maison spécifique.
...
#             # On utilise aussi notre nouvelle méthode ici.
#             locataires = maison.get_locataires_actifs()
