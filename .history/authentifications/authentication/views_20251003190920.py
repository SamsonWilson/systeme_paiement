...
class InboxView(ListView):
    ...
    def get_queryset(self):
        ...
        if user.is_staff:
            ...
            maisons = Maison.objects.filter(chambres__locations__utilisateur=user).distinct()
        
        # On annote chaque maison avec l'ID de son dernier message
        # 'messages' est le related_name de la ForeignKey 'maison' dans le modèle Message
