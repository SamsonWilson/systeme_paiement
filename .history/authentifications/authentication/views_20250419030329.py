...
class  ProprietaireDetaimaisonlView(DetailView):
     model = Proprietairetemplate_name = 'accuiel/proprietaires/proprietaireDetail_Maison.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        for maison in maisons:
            ...
            for chambre in chambres:
                # Toutes les locations (passées + actuelles) avec utilisateur préchargé
                ...
                # Historique détaillé de chaque location associée à la chambre
                locations_details = []
                for loc in locations:
                    ...
                    locations_details.append({
                        ...
                        "taux_commission": chambre.taux_commission,  # ou loc.chambre.taux_commission si jamais c'était historisé
                        "periode": period,
