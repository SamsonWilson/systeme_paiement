...
/*************  ✨ Windsurf Command ⭐  *************/
    """
    Ajoute des informations supplémentaires au contexte, comme le type d'utilisateur,
    ainsi que l'objet user lui-même pour une utilisation plus simple dans le template.
    Les données supplémentaires peuvent être ajoutées manuellement en fonction des besoins
    (par exemple, informations de propriété pour les propriétaires, informations de bail
/*******  0b119ae0-c008-44b5-9f8c-fd4b74c4f5a5  *******/
