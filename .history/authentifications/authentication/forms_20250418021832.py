...
from django.contrib.auth.models import User
import qrcode
from .models import Chambre, CustomUser, Location, Maison, PaiementLoyer, Proprietaire, Quartier, TypeChambre, UserType, Ville,FinLocation
# from django import forms
...
class FinLocationForm(forms.ModelForm):
    class Meta:
        model = FinLocation
        fields = ['location', 'date_fin_location', 'raison_fin', 'montant_restant', 'montant_remboursement_caution', 'image_contrat', 'etat_chambre_final', 'Recu_pdf']
        widgets = {
            ...
            'etat_chambre_final': forms.Textarea(attrs={'rows': 3, 'class': 'form-control'}), # Classe pour textarea
            'Recu_pdf': forms.FileInput(attrs={'class': 'form-control'}), # Classe input file
        }
