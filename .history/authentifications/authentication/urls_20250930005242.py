...
#...existing code...
    ...
    path('generate-pdf/<int:paiementloyer_id>/', PDFTemplateViewpaiyement1.as_view(), name='generate_pdfpayement'),  # noqa: F821
    path('location/<int:location_id>/download/', Download_Payement1_RedirectView.as_view(), name='download_and_redirect_payement1'),
