...
class DownloadAndRedirectView(View):
    """
    ...
    def get(self, request, location_id, *args, **kwargs):
        ...
        context = {
            'pdf_url': reverse('generate_location_pdf', args=[location_id]),
            'home_url': reverse('accueil')  # Assurez-vous d'avoir une URL nommée 'accueil'
        }
