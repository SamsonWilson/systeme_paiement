...
#...existing code...
    ...
    path('generatePayement122-pdf/<int:paiementloyer_id>/', PDFTemplateViewpaiyement1.as_view(), name='generate_pdfpayement'),  # noqa: F821
    path('paiement1/<int:paiementloyer_id>/download/', Download_Payement1_RedirectView.as_view(), name='download_and_redirect_payement1'),
