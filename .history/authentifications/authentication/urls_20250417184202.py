...
# URL pour afficher les paiements d'une location spécifique
    path('location/<int:location_id>/paiements/', ListePaiementsLocationView.as_view(), name='liste_paiepath('liste-paiements/<int:pk>/', views.PaiementListView.as_view(), name='liste_paiements')
ments'),
