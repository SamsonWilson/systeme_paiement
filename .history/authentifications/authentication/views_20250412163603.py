...
class PaiementLoyerListView(ListView):
    ...
    template_name = 'accuiel/paiements/paiement_list.html'
    context_object_name = 'paiements'
    paginate_by = 15  # 15 paiements par page

    def get_queryset(self):
        # On trie les paiements par date_fin_paiement croissante
        return PaiementLoyer.objects.select_related(
            'location__chambre',
            'location__utilisateur'
        ).order_by('date_fin_paiement')
