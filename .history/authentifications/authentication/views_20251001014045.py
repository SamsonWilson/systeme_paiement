...
from .models import Maison, Message, CustomUser, FinLocation
...
class InboxView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # ✅ 2. CETTE LIGNE FONCTIONNE MAINTENANT CAR 'timezone' EST LE BON MODULE
        # On attache le fuseau horaire UTC à la date minimale possible.
