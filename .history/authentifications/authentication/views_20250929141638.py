...
class PDFTemplateViewpaiyement(View):
     def get(self, request, pk):
        ...
        details = PaiementLoyer.details.all()
        template = get_template("Recu/Recu_peyement.html")
        html_content = template.render({"inventaire": PaiementLoyer, "details": details})
        ...
        response['Content-Disposition'] = f'attachment; filename="inventaire_{PaiementLoyer.id}.pdf"'
        return response
