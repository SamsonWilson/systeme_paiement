...
cfrom django.views.generic import ListView
from datetime import datetime, date
import pytz
from .models import PaiementLoyer, Location
...
class PaiementLoyerListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        current_date_togo = datetime.now(pytz.timezone('Africa/Lome')).date()
        ...
        for location in locations:
            ...
            if dernier_paiement:
                ...
                # Si pas de paiement, on ignore cette location
                continue

            date_expiree = date_fin < current_date_togo if date_fin else False
        ...
        # 🟢 Trier du plus ancien au plus récent selon date_fin
        paiements_par_location.sort(
            key=lambda x: x['date_fin'] or date(9999, 12, 31)
        )
