...
# Remove login_required decorator import if no other FBVs use it
# from django.contrib.auth.decorators import login_required
from django.contrib.auth.mixins import LoginRequiredMixin # Import the mixin
from django.views.generic import TemplateView # Import TemplateView
from django.db.models import Sum, Q, Count
from django.http import Http404
from .models import Proprietaire, Maison, Chambre, Location, PaiementLoyer, CustomUser

# Example view for Location detail (if needed by get_absolute_url)
# You might already have this or need to create it
...
class OwnerDashboardView(LoginRequiredMixin, TemplateView):
    """
    Displays a dashboard for the logged-in Proprietaire using a Class-Based View.
    Shows properties, room statuses, and payment summaries.
    """
    template_name = 'gestion/owner_dashboard.html' # Specify the template
