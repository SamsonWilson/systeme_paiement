...
class MessageListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Récupération de l'ID du destinataire et de l'ID de la maison depuis les URL params
        receiver_id = self.kwargs.get('receiver_id')
        ...
        # Cas où aucun destinataire ni maison n'est spécifié (tous les messages de l'utilisateur)
        else:
            messages = Message.objects.filter(
                Q(sender=user) |
                Q(receiver=user) |
