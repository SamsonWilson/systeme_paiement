...
class FinLocationListView(ListView):
    ...
    """
    model = Location  # Le modèle principal que nous listons
    ...
    def get_queryset(self):
        ...
        queryset = location.Chambre.objects.filter(etat='occupée').select_related(  # noqa: F821
            'maison', 
            'maison__proprietaire' # Suit la relation de Maison vers Proprietaire
              # Précharge l'utilisateur lié à chaque location préchargée
        )
        return queryset
