...
/*************  ✨ Windsurf Command 🌟  *************/
    ...
    If the message is a group message, returns a string like "Message de groupe de <sender> - <timestamp> (Maison: <maison.nom>)".
    Otherwise, returns a string like "Message de <sender> à <receiver> - <timestamp>".
    """
    def __str__(self):
        ...
        return f"Message de {self.sender} à {self.receiver} - {self.timestamp}"  
/*******  1d54acfc-a593-4302-a0ea-f32104f62992  *******/
