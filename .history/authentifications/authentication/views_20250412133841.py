...
class PaiementLoyerListView(ListView):
   ...
   def get_context_data(self, **kwargs):
    ...
    # Trier les paiements : les dates expirées en premier, gérer les None pour date_fin
    paiements_par_location.sort(key=lambda x: (not x['date_expiree'], x['date_fin'] or datetime.max.date()))
