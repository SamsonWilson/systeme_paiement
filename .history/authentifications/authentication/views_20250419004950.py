...
class ProprietaireDetaimaisonlView(DetailView):
    model = Proprietaire
    template_name = 'accuiel/proprietaires/proprietaireDetail_Maison.html'  # Créez ce template
    ...
    def get_context_data(self, **kwargs):
        ...
        context['maisons_count'] = proprietaire.maisonscontext['maisons_count'] = proprietaire.maisons.count()
_count()
