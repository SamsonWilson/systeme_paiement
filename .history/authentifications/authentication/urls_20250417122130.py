...
urlpatterns = [
    ...
    path('fin-location/create/', FinLocationCreateView.as_view(), name='fin_location_create'),
    path('fin-location/<int:pk>/update/', FinLocationUpdateView.as_view(), name='fin_location_update'),
    path('chambre/<int:chambre_id>/utilisateurs/', FinLocationListView.as_view(), name='utilisateurs_parchambre'),
    path('chambre/<int:chambre_id>/utilisateurs/', UtilisateursParChambreView.as_view(), name='utilisateurs_parchambre'),
