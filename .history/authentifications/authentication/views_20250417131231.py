...
class FinLocationListView(ListView):
    ...
    template_name = 'votre_app/chambre_li    template_name = 'accuiel/Finlocation/list_utilisateur.html'
bre_list.html'  # Chemin vers votre template
    ...
    def get_queryset(self):
        ...
        queryset = Chambre.objects.filter(etat='libre').select_related(
            'maison', 
