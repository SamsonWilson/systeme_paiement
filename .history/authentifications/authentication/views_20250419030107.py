    ...
    def get_context_data(self, **kwargs):
            ...
            for maison in maisons:
                ...
                for chambre in chambres:
                    locations = chambre.locations.all()
                    ...
                    if locations.exists():
                        location_courante = locations.order_by('-date_debut_location').first()
                        utilisateur = location_courante.utilisateur
                        fin = getattr(location_courante, 'fin_location', None)
                        if fin:
                            date_liberation = fin.date_fin_location
