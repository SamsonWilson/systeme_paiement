...
class MessageIndiv(models.Model):
    senderMessageIndiv = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='sent_messages')
    receiverMessageIndiv = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='received_messages', null=True, blank=True)
    messageMessageIndiv = models.TextField()
    timestampMessageIndiv = models.DateTimeField(auto_now_add=True)
