...
urlpatterns = [
    ...
    path('download-pdf/', ServePDFAndRedirectViewLocation.as_view(), name='serve_pdf_and_redirect'),
     ...
     path('generate-pdf/<int:location_id>/', PDFTemplateViewpaiyement.as_view(), name='generate_pdf'),  # noqa: F821
    path('download-pdf/', ServePDFAndRedirectViewLocationpaiyement.as_view(), name='serve_pdf_and_redirect'),
]