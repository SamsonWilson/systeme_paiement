...
urlpatterns = [
    ...
    path('proprietaire_list_/', ProprietaireListmaisonView.as_view(), name='proprietaire_list_maison'), # URL pour la liste des propriétaires
    path('proprietaire/<int:pk>/', ProprietaireDetaimaisonlView.as_view(), name='proprietaire_detail'),  # noqa: F821
    ################################################################### Villes ######################################################
