...
urlpatterns = [
   ...
   #...existing code...
    ...
    path('messages/', InboxView.as_view(), name='message-list'),
    # path('messages/maison/<int:maison_id>/', MessageListView.as_view(), name='maison_messages'),
    path('messages/maison/int:maison_id/', MaisonMessageView.as_view(), name='message_inbox'),
    path('messages/locataires/<int:maison_id>/locataires/', MaisonLocatairesView.as_view(), name='maison_locataires'),
#...existing code...
    # proprietaire 
