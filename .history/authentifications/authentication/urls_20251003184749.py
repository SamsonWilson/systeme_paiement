...
path("messages/<int:maison_id>/new/", GetNewMessagesView.as_view(), name="get_new_messages"),path("messages/<int:maison_id>/new/", GetNewMessagesView.as_view(), name="get_new_messages"),path("messages/<int:maison_id>/new/", GetNewMessagesView.as_view(), name="get_new_messages"),
#...existing code...
    # proprietaire 
