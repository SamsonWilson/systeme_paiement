...
from django.contrib.auth.mixins import LoginRequiredMixin # Optionnel: Pour restreindre l'accès
...
class ProprietaireDashboardView(LoginRequiredMixin, DetailView): # Hérite de DetailView
    ...
    template_name = 'yourapp/proprietaire_dashboard.html'  # Chemin vers votre template
