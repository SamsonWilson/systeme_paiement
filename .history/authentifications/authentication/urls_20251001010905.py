...
path('messages/maison/int:maison_id/', MaisonMessageView.as_view(),    path('messages/locataires/<int:maison_id>/locataires/', MaisonLocatairesView.as_view(), name='maison_locataires'),
#...existing code...
    # proprietaire 
